...
public class PeliculasDataSource {
     ...
     * @return
     */
    public long insertPelicula(Pelicula peliculaToInsert) {
...
//            pelicula.setUrlCaratula("https://image.tmdb.org/t/p/original/" + cursor.getString(6));
    ...
    /**
     * Obtiene todas las peliculas  con el filtro introducido en el SQL.
     *
     * @return Lista de objetos de tipo Pelicula
     */
    public List<Pelicula> getFilteredPeliculas(String filtro) {
        // Lista que almacenara el resultado
        List<Pelicula> peliculaList = new ArrayList<Pelicula>();
        //hacemos una query porque queremos devolver un cursor
        ...
        Cursor cursor = database.rawQuery("Select * " +
                ...
                " WHERE " + MyDBHelper.TABLA_PELICULAS + "." + MyDBHelper.COLUMNA_CATEGORIA_PELICULAS
                + " = \"" + filtro + "\"", null);
